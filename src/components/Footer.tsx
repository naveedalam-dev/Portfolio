...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { icon: Instagram, url: 'https://instagram.com/umarhashmi.dev', name: 'Instagram' },
    { icon: Linkedin, url: 'https://linkedin.com/in/umarhashmi-dev', name: 'LinkedIn' },
    { icon: Github, url: 'https://github.com/umarhashmi-dev', name: 'GitHub' },
    { icon: Twitter, url: 'https://twitter.com/umarhashmi_dev', name: 'Twitter' }
  ];
        ...
        <div className="py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold">Umar Hashmi</h3>
            ...
            >
              Original creator of VNHAX and PUBHSTUFF tools. Trusted by 250+ global clients 
            ...
            >
              <div className="flex items-center space-x-3 text-gray-400 text-sm lg:text-base">
                ...
                <a href="mailto:contact@umarhashmi.dev" className="hover:text-white transition-colors">
                  contact@umarhashmi.dev
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-400 text-sm lg:text-base">
                <Phone className="w-4 h-4" />
                <a href="https://wa.me/923021550385" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  +92 302 1550385
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-400 text-sm lg:text-base">
        ...
        <div className="py-6 border-t border-gray-800 flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
          ...
          >
            <div className="flex items-center space-x-2">
              <span>© 2025 Umar Hashmi. Made with</span>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-sm text-gray-500">
              ...
              <span className="text-white font-medium">U-Designer</span>
            </div>
          </div>
        </div>
      </div>
